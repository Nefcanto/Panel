...
const Pagination = () => {
    ...
    >
        ...
        >
            ...
            <span className="mx-4">{app.digitGroup(pageNumber)}</span>
            <IconButton
            ...
            >
                {
                    from
                        ?
                        <>
                            <span className="text-blue-900">{app.digitGroup(from)}</span>
                            <span className="mx-2">-</span>
                            <span className="text-blue-900">{app.digitGroup(to)}</span>
                        </>
                        :
                        null
                }
                {
                    totalCount
                        ...
                        <>
                            <span className="mx-2">/</span>
                            <span className="text-blue-900">{app.digitGroup(totalCount)}</span>
                        </>
                        :
                        null
                }
