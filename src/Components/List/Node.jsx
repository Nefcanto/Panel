...
const Node = () => {
    ...
    return <li className={entity.parentId && "ms-8 border-s border-dashed border-slate-400"}>
        <span
        ...
        >
            ...
            <span className="flex justify-between w-full items-center">
                <span className="ms-1 text-sm font-normal text-slate-900">
                    {
                ...
                </span>
                {
                    (entityActions || hasDelete || hasEdit || edit)
                        ?
                        <EntityActions
                            className={"hidden absolute end-0 top-0 bottom-p m-auto group-hover:flex"}
